        ...
        <div id={'about'} style={{ position: 'relative' }}>
            ...
            >
                <div className={'avatar-container col'} style={{ flex: 2 }}>
                    ...
                    />
                    <AchievementsBlock
                        items={info[i18n.language].achievements}
                    />
                </div>
                <div
                    className={'text-container col'}
                    style={{ flex: 5, padding: 0, paddingTop: 40 }}
                >
                        ...
                        <div className={'info-style'}>
                            ...
                            <img
                                ...
                                src={
                                    ...
                                    info[i18n.language].country.short +
                                    '.svg'
                                }
                            />
