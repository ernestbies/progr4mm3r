...
const Hobby = () => {
    ...
    return (
        <div id={'hobby'} className={'carousel-style'}>
            <p style={{color: 'white', display: 'inline-block', fontFamily: 'Open Sans', fontWeight: 300, marginTop: 20}}>Hobby</p>
                    ...
                    <div style={{display: 'flex'}}>
                        ...
                        <div style={{margin: 40, textAlign: 'left', flex: 1}}>
                            <div style={{display: 'flex', textAlign: 'center', alignItems: 'center'}}>
                                ...
                                <p style={{paddingLeft: 7, fontFamily: 'Open Sans', margin: 0}}>{hobby.esports.name}</p>
                            </div>
                            <p style={{
                                fontSize: 14,
                ...
                <Carousel.Item className={'carousel-item'}>
                    <div style={{display: 'flex'}}>
                        <img
                            alt={''}
                            className={'d-block w-50'}
                            src={hobby.programming.image}
                            style={{opacity: 0.5, flex: 1}}
                        />
                        <div style={{margin: 40, textAlign: 'left', flex: 1}}>
                            <div style={{display: 'flex', textAlign: 'center', alignItems: 'center'}}>
                                <div style={{width: 5, height: 30, backgroundColor: 'orange'}}/>
                                <p style={{paddingLeft: 7, fontFamily: 'Open Sans', margin: 0}}>{hobby.programming.name}</p>
                            </div>
                            <p style={{
                                fontSize: 14,
                                fontFamily: 'Open Sans',
                ...
                <Carousel.Item className={'carousel-item'}>
                    <div style={{display: 'flex'}}>
                        <img
                            alt={''}
                            className={'d-block w-50'}
                            src={hobby.cinematography.image}
                            style={{opacity: 0.5, flex: 1}}
                        />
                        <div style={{margin: 40, textAlign: 'left', flex: 1}}>
                            <div style={{display: 'flex', textAlign: 'center', alignItems: 'center'}}>
                                <div style={{width: 5, height: 30, backgroundColor: 'yellow'}}/>
                                <p style={{paddingLeft: 7, fontFamily: 'Open Sans', margin: 0}}>{hobby.cinematography.name}</p>
                            </div>
                            <p style={{
                                fontSize: 14,
                                fontFamily: 'Open Sans',
