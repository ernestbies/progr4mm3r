...
export const BACKEND_URL = 'https://ernestbies-backend.onrender.com';
...
export const shortInfo = {
    en: [
        'programmer',
        'semi-professional e-sports athlete',
        'movies enthusiast',
    ],
...
export const info = {
    en: {
        ...
        text: 'Welcome on my official website! My name is Ernest and I come from Poland. I am a graduate of the State Higher Vocational School in Tarnów in the field of Computer Science, which I graduated with the Medal for "Outstanding Graduates of the State Higher School of Higher Education in Tarnów" awarded by the University Senate. From an early age, I was interested in many things related to Information Technology. While studying at schools, I took part in numerous IT competitions. In my youth, I ran on-line gaming servers that were popular all over the country. I was also a moderator and mentor at the largest forum in Poland at that time - MPCforum about technical news, programming and creating plugins for online game servers. I am constantly trying to develop my skills and broaden my knowledge. In addition to Computer Science, I am interested in many other things, mainly e-sports and cinematography. I have participated in many esports tournaments and played with many players who are famous in the esports world. I always do everything with full commitment.',
        achievements: {
            it: [
                'aspiring developer',
                'owner of multiple game servers',
                'ex-moderator at MPCforum',
            ],
            eSport: [
                'team player',
                'competitive e-sports player',
                'participant of many international tournaments',
            ],
        },
    },
    pl: {
...
export const statusList = {
    ...
    send: {
        ...
        color: 'green',
        description:
            'Message was sent successfully and posted on the Hall of Fame board.',
    },
    error_connect: {
        no: 4,
        code: 'ERROR',
    ...
    error_send: {
        ...
        color: 'red',
        description:
            'There was a problem sending the message (data validation problem).',
    },
};
